...
if (sp == "all") {
  ...
  time_period = "./Data/Historical_biogeography/constrained_model/BioGeoBEARS_time_period.txt"
  connectivity_matrix <- "./Data/Historical_biogeography/constrained_model/BioGeoBEARS_area_matrix.txt"
  dispersal_matrix <- "./Data/Historical_biogeography/constrained_model/BioGeoBEARS_dispersal_matrix.txt"
  ...
  time_period = "./Data/Historical_biogeography/constrained_model/BioGeoBEARS_time_period_Anth.txt"
  connectivity_matrix <- "./Data/Historical_biogeography/constrained_model/BioGeoBEARS_area_matrix_Anth.txt"
  dispersal_matrix <- "./Data/Historical_biogeography/constrained_model/BioGeoBEARS_dispersal_matrix_Anth.txt"
} 
...
DECJ_platyrrhini$num_cores_to_use = 20
...
if (sp == "all") {
  load("./Results/Historical_biogeography/All_Primates/DEC/Constraint_model/Platyrrhini_DEC_allprimate.Rdata")
  resDEC = res
} else if (sp == "Haplorrhini") {
  load("./Results/Historical_biogeography/Haplorrhini/DEC/Constraint_model/Platyrrhini_DEC_Haplo.Rdata")  
  resDEC = res
} else if (sp == "Anthropoidea") {
  load("./Results/Historical_biogeography/Anthropoidea/DEC/Constraint_model/Platyrrhini_DEC_Anth.Rdata")  
  resDEC = res
} 
...
if (sp == "all") {
  resfnj = paste("./Results/Historical_biogeography/",All,"DECJ/Constraint_model/Platyrrhini_DECJ_allprimate.Rdata",sep="")
} else if (sp == "Haplorrhini") {
  resfnj = paste("./Results/Historical_biogeography/",Hap,"DECJ/Constraint_model/Platyrrhini_DECJ_Haplo.Rdata",sep="")
} else if (sp == "Anthropoidea") {
  resfnj = paste("./Results/Historical_biogeography/",Anth,"DECJ/Constraint_model/Platyrrhini_DECJ_Anth.Rdata",sep="")
} 

runslow = F
if (runslow){
  #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
  resj = bears_optim_run(DECJ_platyrrhini)
  resj    
...
#######################################################
if (sp == "all") {
  pdffn = paste("./Results/Historical_biogeography/",All,"DECJ/Constraint_model/Platyrrhini_DECJ_allprimate.pdf",sep="")
} else if (sp == "Haplorrhini") {
  pdffn = paste("./Results/Historical_biogeography/",Hap,"DECJ/Constraint_model/Platyrrhini_DECJ_Haplo.pdf",sep="")
} else if (sp == "Anthropoidea") {
  pdffn = paste("./Results/Historical_biogeography/",Anth,"DECJ/Constraint_model/Platyrrhini_DECJ_Anth.pdf",sep="")
} 
pdf(pdffn, height=30, width=7)
analysis_titletxt ="BioGeoBEARS DECJ+J on platyrrhini w/ dispersal matrix"
tr = read.tree(phy)
...
range_probabilities = as.data.frame(resj$ML_marginal_prob_each_state_at_branch_top_AT_node)
...
if (sp == "all") {
  write.table(range_probabilities, file=paste("./Results/Historical_biogeography/",All,"DECJ/Constraint_model/range_probabilities_primates.txt",sep=""), quote=FALSE, sep="\t")
} else if (sp == "Haplorrhini") {
  write.table(range_probabilities, file=paste("./Results/Historical_biogeography/",Hap,"DECJ/Constraint_model/range_probabilities_Haplo.txt",sep=""), quote=FALSE, sep="\t")
} else if (sp == "Anthropoidea") {
  write.table(range_probabilities, file=paste("./Results/Historical_biogeography/",Anth,"DECJ/Constraint_model/range_probabilities_Anth.txt",sep=""), quote=FALSE, sep="\t")
} 
...
if (sp == "all") {
  write.table(subset_range_probs, file=paste("./Results/Historical_biogeography/",All,"DECJ/Constraint_model/subset_range_probabilities_primates.txt",sep=""), quote=FALSE, sep="\t")
} else if (sp == "Haplorrhini") {
  write.table(subset_range_probs, file=paste("./Results/Historical_biogeography/",Hap,"DECJ/Constraint_model/subset_range_probabilities_Haplo.txt",sep=""), quote=FALSE, sep="\t")
} else if (sp == "Anthropoidea") {
  write.table(subset_range_probs, file=paste("./Results/Historical_biogeography/",Anth,"DECJ/Constraint_model/subset_range_probabilities_Anth.txt",sep=""), quote=FALSE, sep="\t")
} 

####################################
# Calculate per-area probabilities for each node
####################################
relprobs_matrix = resDECj$ML_marginal_prob_each_state_at_branch_top_AT_node
...
if (sp == "all") {
  write.table(subset_probs_each_area, file=paste("./Results/Historical_biogeography/",All,"DECJ/Constraint_model/per-area_probabilities_primates.txt",sep=""),
              sep ="\t", row.names = T, col.names = T, quote = FALSE)
} else if (sp == "Haplorrhini") {
  write.table(subset_probs_each_area, file=paste("./Results/Historical_biogeography/",Hap,"DECJ/Constraint_model/per-area_probabilities_Haplo.txt",sep=""),
              sep ="\t", row.names = T, col.names = T, quote = FALSE)
} else if (sp == "Anthropoidea") {
  write.table (subset_probs_each_area, file=paste("./Results/Historical_biogeography/",Anth,"DECJ/Constraint_model/per-area_probabilities_Anth.txt",sep=""),
               sep ="\t", row.names = T, col.names = T, quote = FALSE)
} 
## References ------------------------------------------------------------------
