...
if (sp == "all") {
  resfn = paste("./Results/Historical_biogeography/",All,"DEC/Constraint_model/Platyrrhini_DEC_allprimate.Rdata",sep="")
} else if (sp == "Haplorrhini") {
  resfn = paste("./Results/Historical_biogeography/",Hap,"DEC/Constraint_model/Platyrrhini_DEC_Haplo.Rdata",sep="")
} else if (sp == "Anthropoidea") {
  resfn = paste("./Results/Historical_biogeography/",Anth,"DEC/Constraint_model/Platyrrhini_DEC_Anth.Rdata",sep="")
} 
...
#######################################################
if (sp == "all") {
  pdffn = paste("./Results/Historical_biogeography/",All,"DEC/Constraint_model/Platyrrhini_DEC_allprimate.pdf",sep="")
} else if (sp == "Haplorrhini") {
  pdffn = paste("./Results/Historical_biogeography/",Hap,"DEC/Constraint_model/Platyrrhini_DEC_Haplo.pdf",sep="")
} else if (sp == "Anthropoidea") {
  pdffn = paste("./Results/Historical_biogeography/",Anth,"DEC/Constraint_model/Platyrrhini_DEC_Anth.pdf",sep="")
} 
...
if (sp == "all") {
  write.table(range_probabilities, file=paste("./Results/Historical_biogeography/",All,"DEC/Constraint_model/range_probabilities_primates.txt",sep=""), quote=FALSE, sep="\t")
} else if (sp == "Haplorrhini") {
  write.table(range_probabilities, file=paste("./Results/Historical_biogeography/",Hap,"DEC/Constraint_model/range_probabilities_Haplo.txt",sep=""), quote=FALSE, sep="\t")
} else if (sp == "Anthropoidea") {
  write.table(range_probabilities, file=paste("./Results/Historical_biogeography/",Anth,"DEC/Constraint_model/range_probabilities_Anth.txt",sep=""), quote=FALSE, sep="\t")
} 
...
if (sp == "all") {
  write.table(subset_range_probs, file=paste("./Results/Historical_biogeography/",All,"DEC/Constraint_model/subset_range_probabilities_primates.txt",sep=""), quote=FALSE, sep="\t")
} else if (sp == "Haplorrhini") {
  write.table(subset_range_probs, file=paste("./Results/Historical_biogeography/",Hap,"DEC/Constraint_model/subset_range_probabilities_Haplo.txt",sep=""), quote=FALSE, sep="\t")
} else if (sp == "Anthropoidea") {
  write.table(subset_range_probs, file=paste("./Results/Historical_biogeography/",Anth,"DEC/Constraint_model/subset_range_probabilities_Anth.txt",sep=""), quote=FALSE, sep="\t")
} 
...
if (sp == "all") {
  write.table(subset_probs_each_area, file=paste("./Results/Historical_biogeography/",All,"DEC/Constraint_model/per-area_probabilities_primates.txt",sep=""),
              sep ="\t", row.names = T, col.names = T, quote = FALSE)
} else if (sp == "Haplorrhini") {
  write.table(subset_probs_each_area, file=paste("./Results/Historical_biogeography/",Hap,"DEC/Constraint_model/per-area_probabilities_Haplo.txt",sep=""),
              sep ="\t", row.names = T, col.names = T, quote = FALSE)
} else if (sp == "Anthropoidea") {
  write.table (subset_probs_each_area, file=paste("./Results/Historical_biogeography/",Anth,"DEC/Constraint_model/per-area_probabilities_Anth.txt",sep=""),
               sep ="\t", row.names = T, col.names = T, quote = FALSE)
} 
## References ------------------------------------------------------------------
